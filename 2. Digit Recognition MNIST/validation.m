...
% 
    ...
    for n = 1: testSetSize
        ...
        outputVector = evaluateTwoLayerPerceptron(activation, hiddenWeights, outputWeights, inputVector);
...
function outputVector = evaluateTwoLayerPerceptron(activation, hiddenWeights, outputWeights, inputVector)
